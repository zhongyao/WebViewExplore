...
import com.hongri.webview.copy.drag.DragController;
import com.hongri.webview.copy.drag.DragLayer;
import com.hongri.webview.copy.drag.DragListener;
import com.hongri.webview.copy.drag.DragSource;
import com.hongri.webview.copy.drag.MyAbsoluteLayout;
import com.hongri.webview.copy.drag.PopItemClickListener;
import com.hongri.webview.copy.selection.TextSelectionJavascriptInterface;
import com.hongri.webview.copy.selection.TextSelectionJavascriptInterfaceListener;
...
import com.hongri.webview.copy.view.ActionItem;
import com.hongri.webview.copy.view.QuickAction;
import com.hongri.webview.copy.view.QuickAction.OnDismissListener;
...
public class SelectionWebView extends WebView implements TextSelectionJavascriptInterfaceListener,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        Logger.d(TAG, "onTouch:" + " event:" + event.getAction());
    ...
    public boolean onLongClick(View v) {
        ...
        if (!isInSelectionMode()) {
            Logger.d(TAG, "selection.longTouch");
